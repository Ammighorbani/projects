...
<head>
<meta charset="UTF-8">
<title>فرم کامل رزومه - نسخه نهایی</title>
<style>
    body{font-family:Tahoma;background:#f4f6f9;padding:20px;}
    .c{max-width:1200px;margin:auto;background:#fff;padding:40px;border-radius:16px;box-shadow:0 10px 40px rgba(0,0,0,0.1);}
    h1,h2{color:#2c3e50;}
    .s{background:#f8f9fc;padding:30px;margin:30px 0;border-radius:12px;}
    input,textarea,select{width:100%;padding:14px;margin:8px 0;border:1px solid #ccc;border-radius:8px;box-sizing:border-box;}
    textarea{min-height:110px;}
    .item{position:relative;background:#fff;padding:30px;margin:20px 0;border:2px dashed #ddd;border-radius:12px;}
    .del{position:absolute;top:10px;left:10px;background:#e74c3c;color:#fff;padding:8px 16px;border:none;border-radius:8px;cursor:pointer;}
    .add{background:#3498db;color:#fff;padding:12px 28px;border:none;border-radius:8px;cursor:pointer;}
    button[type=submit]{background:#27ae60;color:#fff;padding:20px;font-size:22px;border:none;border-radius:12px;width:100%;cursor:pointer;margin-top:40px;}
    .success{background:#d4edda;color:#155724;padding:20px;border-radius:12px;text-align:center;font-weight:bold;margin:20px 0;}
</style>
</head>
<body>
<div class="c">
    <h1>فرم کامل رزومه - نسخه نهایی</h1>
    ...
    <form method="post">
            ...
            <div id="projectContainer">
                ...
                <div class="item">
                    ...
                    <select name="projects[<?=$i?>][type]">
                        ...
                        <option value="open-source" <?=($p['type']??'')=='open-source'?'selected':''?>>اوپن سورس</option>
        ...
        <button type="submit">ذخیره کامل رزومه</button>
    </form>
</div>
